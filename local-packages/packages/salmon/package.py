...
# Download pufferfish for the matching version and run sha256sum to get the checksum
# For specific package repos see: https://github.com/COMBINE-lab/
# For pufferfish: wget https://github.com/COMBINE-lab/pufferfish/archive/salmon-v1.9.0.zip

    resources = [
        ('1.9.0', 'pufferfish', '2a862daeff95a19c9b188bc26a5d02fc0ecc5b9c9ae5523a67c9d14e62551c5d'),
